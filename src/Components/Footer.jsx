      ...
      <div className="container relative z-10 mx-auto px-2">
        <div className="-m-8 flex flex-wrap items-center justify-between">
          ...
          <div className="w-auto p-8">
            <a href="#">
              <div className="inline-flex items-center">
                ...
                <span className="ml-4 text-2xl font-bold">MOHAMMAD SHARIF</span>
              </div>
            </a>
          </div>

          {/* Social Icons */}
          <div className="w-[30%] h-[4rem] flex justify-between ">
              <div className="w-[18%] p-1.5 ">
                <a href="#">
                  <div className="flex h-[100%] w-[100%] text-4xl items-center justify-center rounded-full border border-gray-300 hover:border-gray-400">
          ...
          <div className="mt-4 md:mt-0">
            <p className="text-lg font-medium text-black">© 2024 Mohammad Sharif. All rights reserved.</p>
          </div>
        </div>
      </div>
    </section>
